...
func (s SwapTokenPair) String() string {
	return strings.TrimSpace(fmt.Sprintf(`BasePooledCoin: %s QuotePooledCoin: %s PoolTokenName: %s`, s.BasePooledCoin.String(), s.QuotePooledCoin.String(), s.PoolTokenName))
}
